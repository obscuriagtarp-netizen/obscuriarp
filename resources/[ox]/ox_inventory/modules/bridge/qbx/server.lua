...
function server.setPlayerData(player)
    ...
    return {
        ...
        groups = groups,
        class = player.metadata and player.metadata.classe or nil,
        sex = player.charinfo.gender,
        dateofbirth = player.charinfo.birthdate,
    }
end

function server.getPlayerClass(source)
    local player = QBX:GetPlayer(source)
    return player and player.PlayerData.metadata and player.PlayerData.metadata.classe or nil
end
