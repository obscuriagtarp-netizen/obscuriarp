return {
    ...
    ['amuleto_latente'] = {
        ...
        equipment = 'amulet',
        attributes = {},
        description = 'Um receptaculo arcano ainda sem atributos vinculados.',
        client = {
    ...
    ['colar_latente'] = {
        ...
        equipment = 'necklace',
        attributes = {},
        description = 'Um colar sobrenatural preparado para receber atributos.',
        client = {
            image = 'goldchain.png'
        }
    },
    ...
    ['cinto_latente'] = {
        ...
        equipment = 'belt',
        attributes = {},
        description = 'Um cinto ritualistico preparado para receber efeitos.',
        client = {
            image = 'harness.png'
        }
    },
    ...
    ['anel_latente'] = {
        ...
        equipment = 'ring',
        attributes = {},
        description = 'Um anel encantado ainda sem atributos vinculados.',
        client = {
	...
	['amuleto_eclipse'] = {
		...
		description = 'Um artefato antigo que protege vampiros da luz solar quando equipado.',
		weight = 180,
		stack = false,
		close = false,
		consume = 0,
	...
	['anel_sangue_ancestral'] = {
		...
		description = 'Uma joia vampírica marcada por uma linhagem antiga. Válida por 7 dias.',
		weight = 35,
		stack = false,
		close = false,
		consume = 0,
	...
	['cinto_presa_carmesim'] = {
		...
		description = 'Um talismã de caça trançado com contas cor de sangue. Válido por 7 dias.',
		weight = 190,
		stack = false,
		close = false,
		consume = 0,
	...
	['amuleto_veu_arcano'] = {
		...
		description = 'Um foco violeta criado para conduzir magia instável. Válido por 7 dias.',
		weight = 80,
		stack = false,
		close = false,
		consume = 0,
	...
	['anel_eco_runico'] = {
		...
		description = 'Runas antigas percorrem o aro quando uma magia é conjurada. Válido por 7 dias.',
		weight = 30,
		stack = false,
		close = false,
		consume = 0,
	...
	['cinto_selo_da_lua'] = {
		...
		description = 'Um selo ritualístico que desperta sob o brilho da lua. Válido por 7 dias.',
		weight = 200,
		stack = false,
		close = false,
		consume = 0,
	...
	['amuleto_seiva_sagrada'] = {
		...
		description = 'Um cristal vivo que pulsa com energia restauradora. Válido por 7 dias.',
		weight = 85,
		stack = false,
		close = false,
		consume = 0,
	...
	['anel_segundo_folego'] = {
		...
		description = 'Uma aliança consagrada para os instantes de maior fragilidade. Válida por 7 dias.',
		weight = 30,
		stack = false,
		close = false,
		consume = 0,
	...
	['cinto_guardiao_vital'] = {
		...
		description = 'Um vínculo protetor usado por guardiões da vida. Válido por 7 dias.',
		weight = 195,
		stack = false,
		close = false,
		consume = 0,
