Locales["pt-BR"] = {
    ...
    outfits = {
        ...
        save = {
            menuTitle = "Salvar Traje Atual",
            menuDescription = "Salve seu traje atual como um traje %s",
            description = "Salve seu traje atual",
            title = "Nomeie seu traje",
            managementTitle = "Detalhes do Traje Gerenciado",
            name = {
                label = "Nome do Traje",
                placeholder = "Um traje especial"
            },
            gender = {
                label = "Gênero",
                male = "Masculino",
            ...
            failure = {
                ...
                description = "Já existe um traje com este nome"
            },
            success = {
                title = "Sucesso",
                description = "O traje %s foi salvo"
            }
        },
        update = {
            title = "Atualizar Traje",
            description = "Salve sua roupa atual em um traje existente",
            failure = {
                title = "Falha na Atualização",
                description = "Este traje não existe"
            },
            success = {
                title = "Sucesso",
                description = "O traje %s foi atualizado"
            }
        },
        change = {
            title = "Mudar Traje",
            description = "Escolha entre seus %s trajes salvos",
            pDescription = "Escolha entre seus trajes salvos",
            failure = {
                title = "Algo deu errado",
                description = "O traje escolhido não possui uma aparência base",
            }
        },
        delete = {
            title = "Deletar roupa",
