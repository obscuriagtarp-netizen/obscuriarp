...
-- Textos exibidos no cabecalho da NUI em cada ponto de personalizacao.
Config.AppearanceContexts = {
    default = {
        eyebrow = "Obscuria",
        title = "Personalização de Personagem",
        description = "Ajuste sua aparência com cuidado antes de continuar."
    },
    character = {
        eyebrow = "Primeiros passos",
        title = "Criação de Personagem",
        description = "Defina os traços, o vestuário e os detalhes do seu personagem."
    },
    clothing = {
        eyebrow = "Vestuário",
        title = "Loja de Roupas",
        description = "Combine roupas e acessórios para construir sua identidade."
    },
    barber = {
        eyebrow = "Cuidados pessoais",
        title = "Barbearia",
        description = "Escolha o corte, a barba e os detalhes que definem seu estilo."
    },
    tattoo = {
        eyebrow = "Arte corporal",
        title = "Estúdio de Tatuagem",
        description = "Explore desenhos e marque sua história na pele."
    },
    surgeon = {
        eyebrow = "Estética",
        title = "Clínica de Aparência",
        description = "Refine os traços e a estrutura facial do seu personagem."
    },
    complete = {
        eyebrow = "Editor completo",
        title = "Personalização de Personagem",
        description = "Revise todos os detalhes da sua aparência."
    }
}
