return {
    ...
    threshold = {
        health = 120.0,          -- Health difference needed to break off wheel (LastHealth - CurrentHealth)
        speed  = 130.0,          -- Speed difference needed to break off wheel (LastSpeed - CurrentSpeed)
        heavy  = 150.0,          -- Speed difference needed to disable vehicle instantly (LastSpeed - CurrentSpeed)
    },
