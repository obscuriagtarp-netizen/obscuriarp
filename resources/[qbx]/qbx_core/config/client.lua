return {
    ...
    pauseMapText = 'Obscuria', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear

    characters = {
        useExternalCharacters = true, -- Character selection is handled by ob_multichar.
        enableDeleteButton = true, -- Whether players should be able to delete characters themselves.
        startingApartment = false, -- New characters use the configured Qbox default spawn and appearance flow.
